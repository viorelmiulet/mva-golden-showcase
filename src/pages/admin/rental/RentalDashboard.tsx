...
const RentalDashboard = () => {
  ...
  const stats = [
    { title: "Proprietăți", value: totalProperties, subtitle: `${rentedProperties} închiriate · ${availableProperties} disponibile`, icon: Home, color: "text-brass", bg: "bg-brass/20" },
    ...
    { title: "Tichete Deschise", value: openTickets, subtitle: "de rezolvat", icon: TicketCheck, color: "text-brass", bg: "bg-brass/20" },
