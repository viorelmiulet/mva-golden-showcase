      ...
      <Card className="border-emerald-500/40">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            URL feed produse (recomandat)
            <Badge variant="secondary" className="text-[10px]">format: products · default</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <div className="text-xs text-muted-foreground space-y-1 pt-2 border-t">
            <p className="font-semibold text-foreground">Câmpuri incluse (toate cele cerute de WhatsApp Business + Meta Commerce):</p>
            ...
            <ol className="list-decimal pl-5 space-y-0.5">
              <li>În aplicația <strong>WhatsApp Business</strong> → Settings → <strong>Business tools</strong> → <strong>Catalog</strong>.</li>
              <li>Sau în Meta Business Suite → WhatsApp → Catalog → conectează catalogul de produse de mai sus.</li>
              <li>După prima sincronizare reușită, produsele apar direct în WhatsApp.</li>
            </ol>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-muted">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2 text-muted-foreground">
            URL feed Home Listings (Real Estate — legacy)
            <Badge variant="outline" className="text-[10px]">format: home_listings</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-2">
          <div className="flex flex-col md:flex-row gap-2">
            <input
              readOnly
              value={HOME_LISTINGS_URL}
              className="flex-1 px-3 py-2 text-sm bg-muted rounded-md border border-border font-mono text-foreground"
              onFocus={(e) => e.target.select()}
            />
            <Button variant="outline" onClick={() => copyLink(HOME_LISTINGS_URL, "URL-ul feed-ului home listings")} className="gap-2">
              <Copy className="h-4 w-4" /> Copiază link
            </Button>
          </div>
          <p className="text-[11px] text-muted-foreground">
            Format <strong>Meta Real Estate (Home Listings)</strong>. <strong>NU</strong> este acceptat de WhatsApp Business Catalog — folosește-l doar dacă ai un catalog separat de tip Real Estate în Commerce Manager.
          </p>
        </CardContent>
      </Card>
