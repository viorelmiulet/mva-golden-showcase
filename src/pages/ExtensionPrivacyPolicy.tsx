  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href="https://www.mvaimobiliare.ro/extensie-chrome-privacy" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.mvaimobiliare.ro/extensie-chrome-privacy" />
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg dark:prose-invert max-w-none space-y-6 sm:space-y-8">
            ...
            <section>
              ...
              <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-secondary/50 rounded-lg">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">Website: https://www.mvaimobiliare.ro</p>
              </div>
            </section>
          </div>
        </main>
