/**
 * Server-only OG image generator (ported from supabase/functions/og-image).
 * Generates a branded 1200x630 SVG for property/project/immoflux entities.
 */
...
export async function handleOgImage(req: Request): Promise<Response> {
  try {
