  ...
  <section className="space-y-2" aria-label="Se încarcă locația…">
    <div className="flex items-center justify-between flex-wrap gap-2">
      <div className="flex items-center gap-2">
        <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-brass flex-shrink-0" />
        <AnimatedSkeleton className="h-5 w-40 sm:w-56" />
      </div>
      <AnimatedSkeleton className="h-4 w-28 sm:w-40" />
    </div>
    <div className="relative w-full h-[300px] sm:h-[400px] md:h-[460px] rounded-lg overflow-hidden border border-brass/20 bg-muted">
