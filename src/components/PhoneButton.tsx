    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <a
          ...
          onClick={handleClick}
          className="group fixed bottom-20 right-4 z-50 flex items-center justify-center w-14 h-14 bg-primary text-black rounded-full  transition-all duration-300 active:scale-95 touch-manipulation hover:scale-110 hover:shadow-[0_0_25px_hsl(var(--primary)/0.6)] hover:rotate-[15deg]"
