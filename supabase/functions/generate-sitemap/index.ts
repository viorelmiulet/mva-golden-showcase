...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      { loc: '/pareri-militari-residence', priority: '0.85', changefreq: 'weekly', lastmod: currentDate },
      { loc: '/garsoniere-militari-residence', priority: '0.85', changefreq: 'weekly', lastmod: currentDate },
      { loc: '/ghid-militari-residence', priority: '0.8', changefreq: 'weekly', lastmod: currentDate },
      { loc: '/facilitati-militari-residence', priority: '0.8', changefreq: 'weekly', lastmod: currentDate },
      { loc: '/viata-in-militari-residence', priority: '0.8', changefreq: 'weekly', lastmod: currentDate },
      { loc: '/militari-vs-chiajna-comparatie', priority: '0.8', changefreq: 'monthly', lastmod: currentDate },
      { loc: '/comparatie-complexuri-militari-chiajna', priority: '0.8', changefreq: 'monthly', lastmod: currentDate },
      { loc: '/top-ansambluri-rezidentiale-sector-6', priority: '0.8', changefreq: 'monthly', lastmod: currentDate },
      ...
      { loc: '/costuri-tranzactie-imobiliara', priority: '0.7', changefreq: 'monthly', lastmod: currentDate },
      { loc: '/ghid-noua-casa-2024', priority: '0.7', changefreq: 'monthly', lastmod: currentDate },
      ...
      { loc: '/sitemap', priority: '0.3', changefreq: 'monthly', lastmod: currentDate },
      ...
      { loc: '/politici-editoriale', priority: '0.3', changefreq: 'yearly', lastmod: currentDate },
