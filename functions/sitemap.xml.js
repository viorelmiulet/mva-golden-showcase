/**
 * Cloudflare Pages Function: proxy /sitemap.xml → Supabase Edge Function.
 * Replaces the Netlify [[redirects]] rule that's no longer active.
 */
...
export async function onRequest() {
  try {
    ...
    console.error("[sitemap.xml proxy] error:", err);
